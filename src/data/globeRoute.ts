...
// sensible real-world point for the globe, while `label` stays exactly
// what was given so the displayed text is always faithful to the source.
...
export const globeRoute: RouteStop[] = [
  { label: 'Amsterdam, Holland', lat: 52.3676, lon: 4.9041 },
  ...
  { label: 'Yangtze River Cruise', lat: 30.684, lon: 111.287 },
  ...
  { label: 'Overnight Sleeper Train', lat: 35.6, lon: 118.5 },
